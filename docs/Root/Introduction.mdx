...
***Works with all CUDA workloads and models (transformers, Vision, NLP & others)- Pytorch, vLLM***
***JAX support coming very soon***

WoolyAI can be deployed on your GPU hosts(on-prem or in cloud). There are three main ways to deploy WoolyAI:
...
3. Direct to WoolyAI Server (useful for small scale deployments with single GPU setup)
